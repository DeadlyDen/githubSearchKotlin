...
data class RepositoryItemDB constructor(@PrimaryKey @Unique var id: Int = 0, @Column var name: String = "", @Column var url: String = "", @Column var isViewed : Boolean = false) : BaseModel() {
